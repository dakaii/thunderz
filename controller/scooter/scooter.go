...
type repository interface {
	GetScootersNearby(latitude float64, longitude float64, distance int, limit int64) ([]model.Point, error)
}
...
func (c *Controller) GetNearbyScooters(latitude float64, longitude float64, distance int, limit int64) ([]model.Point, error) {
